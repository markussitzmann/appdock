...
DATABASES = {
    'default': {
            ...
            'NAME': os.environ['APPDOCK_USER'],
            'USER':  os.environ['APPDOCK_USER'],
            'PASSWORD': os.environ['APPDOCK_DB_PASSWORD'],
            'HOST': os.environ['APPDOCK_DB_HOST'],
            'PORT': os.environ['APPDOCK_DB_PORT']
    }
}
